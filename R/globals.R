...
utils::globalVariables(c(
  ...
  "climate_type",
  ".t_sigma_symb", ".t_sigma_ns", ".ai_threshold",
  ".ph_opt", ".ph_sigma", ".som_ref",
  ...
  "alloc_total", "avail_Province",
  "cap_per_row",
  "excess", "feed_rank", "feedtype_graniv",
  "grassland_capped",
  "fixed_demand", "hierarchy_level", "is_grassland", "is_monogastric",
  ...
  "reduction", "row_id",
  "tie_avail_id", "tie_demand_id", "tie_priority",
