...
load_vectors <- function(env = parent.frame()) {
  ...
  Production_colour <- get("Production_colour", envir = env)
  Residue_colour <- get("Residue_colour", envir = env)
  ...
  Oilseeds_colour <- get("Oilseeds_colour", envir = env)
  ...
  Grains_colour <- get("Grains_colour", envir = env)
