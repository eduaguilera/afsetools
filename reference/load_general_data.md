...
dataframes via \`load_vectors()\`. This function creates 80 objects (or
380+ with vectors) in the calling environment including: - 35
...
coefficient objects from Biomass_coefs.xlsx - 1 NPP model coefficient
