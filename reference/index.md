...
- [`` `%!in%` ``](https://eduaguilera.github.io/afsetools/reference/not_in.md)
  : Exclude operator
...
- [`HI_crop_ranges`](https://eduaguilera.github.io/afsetools/reference/HI_crop_ranges.md)
  : Crop-Group Harvest Index Ranges
- [`Crop_RS_N_response`](https://eduaguilera.github.io/afsetools/reference/Crop_RS_N_response.md)
